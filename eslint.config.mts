...
export default tseslint.config(
	...
	},
	{
		...
		rules: {
			...
			// Mocks mirror Obsidian's async API surface (Vault.create/read/process,
			// Plugin.loadData, ...); they must declare `async`/return a Promise to
			// match those signatures even when the stub body has nothing to await.
